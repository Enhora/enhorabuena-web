<template>
  ...
  >
    <template v-slot:top>
      <v-toolbar flat>
        <v-toolbar-title>Tabla de ventas</v-toolbar-title>
        <v-spacer></v-spacer>
...
export default {
  ...
  methods: {
    getColor(stock) {
      ...
      else if (stock < 200 && stock > 100) return "orange";
      else return "green";
    }
  }
};
